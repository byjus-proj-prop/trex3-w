...
function setup() {
  ...
  solo = createSprite(width/2,height+180,width,200);
...
function gerarNuvens() {
  ...
  if (frameCount % 60 === 0) {
    ...
    nuvem.y = Math.round(random(height-95,height-300));
...
function gerarObstaculos() {
  if(frameCount % 60 === 0) {
    var obstaculo = createSprite(camera.position.x+350,height-35,10,40);
